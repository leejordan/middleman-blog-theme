...
<pre class="prettyprint">display: block;
display: flex;</pre>
...
<pre class="prettyprint">display: -ms-flexbox;
display: -webkit-flex;
display: flex;</pre>
...
<pre class="prettyprint">.flexblock-basic {
    display: block;
    display: flex;
    flex-wrap: wrap;
}
...
<pre class="prettyprint">.flexblock {
    display: block;
    display: -ms-flexbox;
    display: -webkit-flex;
    display: flex;
...
<pre class="prettyprint">.flexblock--center-h {
    text-align: center;
...
<pre class="prettyprint">.flexblock--justify {
    text-align: justify;
